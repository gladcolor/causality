...
class Causal_graph():
    """
    class for the causal graph. Carefully maintain it.  
    ...
    def save_graph(self):  # save the pickle, not graphml
#         , graph=True
        new_name = os.path.join(self.save_dir, f"{'_'.join(self.phenomena)}.pkl")
    
        with open(new_name, "wb") as f:
            pickle.dump(self, new_name)
